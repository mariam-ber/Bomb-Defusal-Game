...
# Generaate the combination of switched toggles
def genToggleCombination(decimal):
        #From chatgpt converts dec to bin
    if 0 <= decimal <= 15:
...
if(button_color == "R"):
    button_target = str(toggles_target)
...
boot_text = f"Booting...\n\x00\x00"\
            ...
            f"*Toggle Pattern: {toggles_target}\n"\
            f"*Wire Pattern: {wires_target}\n"\
